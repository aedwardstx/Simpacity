...
#a controller to export to CSV
  ...
  def per_link
    @post_var = get_post_var
    @charts = get_all_int_data(@post_var['start_epoch'],@post_var['end_epoch'],@post_var['watermark'],@post_var['percentile'])
  ...
  def link_group
    @post_var = get_post_var
    @charts = get_all_int_group_data(@post_var['start_epoch'],@post_var['end_epoch'],@post_var['watermark'],@post_var['percentile'])
    respond_to do |format|
      format.html
      format.xls 
    end
